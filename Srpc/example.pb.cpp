...
const uint32_t TableStruct_example_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::srpc::EchoRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::srpc::EchoRequest, message_),
  PROTOBUF_FIELD_OFFSET(::srpc::EchoRequest, name_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::srpc::EchoResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::srpc::EchoResponse, message_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::srpc::EchoRequest)},
  { 8, -1, -1, sizeof(::srpc::EchoResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::srpc::_EchoRequest_default_instance_._instance,
  &::srpc::_EchoResponse_default_instance_._instance,
};

const char descriptor_table_protodef_example_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rexample.proto\022\004srpc\",\n\013EchoRequest\022\017\n\007"
  "message\030\001 \001(\t\022\014\n\004name\030\002 \001(\t\"\037\n\014EchoRespo"
  "nse\022\017\n\007message\030\001 \001(\t28\n\007Example\022-\n\004Echo\022"
  "\021.srpc.EchoRequest\032\022.srpc.EchoResponseb\006"
  "proto3"
  ;
static ::_pbi::once_flag descriptor_table_example_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_example_2eproto = {
    false, false, 166, descriptor_table_protodef_example_2eproto,
    "example.proto",
...
EchoRequest::EchoRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:srpc.EchoRequest)
}
EchoRequest::EchoRequest(const EchoRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:srpc.EchoRequest)
}
...
EchoRequest::~EchoRequest() {
  // @@protoc_insertion_point(destructor:srpc.EchoRequest)
...
// @@protoc_insertion_point(message_clear_start:srpc.EchoRequest)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "srpc.EchoRequest.message"));
        } else
          goto handle_unusual;
        continue;
      // string name = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "srpc.EchoRequest.name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* EchoRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:srpc.EchoRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:srpc.EchoRequest)
  return target;
}

size_t EchoRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:srpc.EchoRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:srpc.EchoRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:srpc.EchoRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
EchoResponse::EchoResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:srpc.EchoResponse)
}
EchoResponse::EchoResponse(const EchoResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:srpc.EchoResponse)
}
...
EchoResponse::~EchoResponse() {
  // @@protoc_insertion_point(destructor:srpc.EchoResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:srpc.EchoResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "srpc.EchoResponse.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* EchoResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:srpc.EchoResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:srpc.EchoResponse)
  return target;
}

size_t EchoResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:srpc.EchoResponse)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:srpc.EchoResponse)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:srpc.EchoResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::srpc::EchoRequest*
Arena::CreateMaybeMessage< ::srpc::EchoRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::srpc::EchoRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::srpc::EchoResponse*
Arena::CreateMaybeMessage< ::srpc::EchoResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::srpc::EchoResponse >(arena);
}
